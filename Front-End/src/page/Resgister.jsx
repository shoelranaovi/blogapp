...
export default function Singup() {
  ...
  async function submit(e) {
    ...
    e.preventDefault();
    try {
      const response = await userRegister(fromdata).unwrap();
  ...
  return (
    <div className="max-w-sm mx-auto mb-4 bg-white p-4 mt-10 ">
      <form className="flex flex-col gap-6">
        <div>
          <h1 className="font-bold text-3xl">Please Fill Up </h1>
        </div>
        <div className="w-full justify-center items-center flex gap-6 p-2 ">
          ...
          <input
            className="  bg-slate-200 h-10 focus:outline-none px-2 text-lg focus:border"
            type="username"
        ...
        <div className="w-full justify-between items-center flex gap-6 p-3 ">
        ...
        <div className=" justify-between items-center flex gap-4 p-2 ">
          <label className="" htmlFor="email">
            {" "}
            Password:
          </label>
